...
　`\verb`というのはverbatim［逐語的に／一字一句変えずに］の略で、記号（縦棒じゃなくてもいい。`\verb!fa#!`とかでもいい）で挟んだ部分を文字通り出力できるコマンドです。これは本文とくっつけて書いても大丈夫です。  
...
　以下をコピペして、 _「正規表現」のところにチェックを入れてから**上から順に**_ 「すべて置換」してください。
