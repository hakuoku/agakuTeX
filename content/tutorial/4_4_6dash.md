...
　それで全然気にならない人、あるいは繋がるフォントを使うことにした人には無用の試みなんですが、筆者はどうしても繋げたくてじたばたあがいてみました。
...
　これの間を繋げるには、基本的には以下のマクロでコマンドを定義してそれを使います。
...
　これでハイフン6つでダッシュが出力できるようになりました。普段スマホメインで書いている人などは、もしかしたらこっちの方法が楽かもしれません。
